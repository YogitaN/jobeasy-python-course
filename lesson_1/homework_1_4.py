...
result_string_1 = 'This is string number 1'
result_string_2 = "This is string number 2"
result_string_3 = '"This is string number 3"'
...
result_planet = 'Earth'
result_planet = result_planet.upper()
